...
Основные группы: 1xx — информационные, 2xx — успех (200 OK, 201 Created), 3xx — перенаправления (301, 302), 4xx — ошибки клиента (400, 401, 403, 404), 5xx — ошибки сервера (500, 502, 503). Код 404 означает, что запрошенный ресурс не найден на сервер
